...
> testcheck = check 
> check1 = check (Sing 'a') "abc" == Just "bc"
> check2 = check (Sing 'z') "zok" == Just "ok"

> testconcat = (Sing 'a') :.: (Sing 'b')
> testconcat_1 = check testconcat "abc" == Just "c"
> testconcat_2 = check testconcat "abuz" == Just "uz"

> testregex = (star((Sing 'c') :.: (Sing 'a')))
> testregex_1 = check testregex "abc" == Just "abc"
> testregex_2 = check testregex "aabbcc" == Just "aabbcc"
