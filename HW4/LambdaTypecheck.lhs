...
> typecheck (Less e1 e2) g =
>   case typecheck e1 g of
>     Error err -> Error ("less than left operand:\n" ++ err)
>     Type NUM ->
>       case typecheck e2 g of
>         Error err -> Error ("less than right operand:\n" ++ err)
>         Type NUM -> Type BOOL
>         Type t -> Error ("can't do less than on right operand of type " ++ show t)
>     Type t -> Error ("can't do less than left operand of type " ++ show t)
