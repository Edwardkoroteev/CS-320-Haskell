...
> test3 = readProp "A & B & !C" == AND (IN "A") (AND (IN "B") (NOT (IN "C")))
> test4 = readProp "A & !B" == AND (IN "A") (NOT (IN"B"))
> test5 = readProp "!A | !B & C" == OR (NOT (IN "A")) (AND (NOT (IN "B")) (IN "C"))
...
> parseConjunction = parseAnd <|> parseNegation
...
> parseNegation = parseNot <|> parseAtom
